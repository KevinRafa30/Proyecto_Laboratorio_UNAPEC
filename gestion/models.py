...
# 1. ESTADOS PARA LAS RESERVACIONES
ESTADOS_RESERVA = [
    ('A', 'Activa'),
    ('P', 'Pendiente'),
    ('C', 'Cancelada'),
    ('I', 'Inactiva/Finalizada'),
]

# 2. ESTADOS PARA LOS MANTENIMIENTOS (Campus, Edificios, etc.)
...
class Campus(models.Model):
    ...
    estado = models.CharField(max_length=1, choices=ESTADOS_MANTENIMIENTO, default='A')
